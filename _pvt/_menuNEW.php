   ...
   if(isImage($file)){
    ...
    if( $file!=$videofile){
     ...
     if(isFilter($file)){
	  ...
	  //wrtb("file=".$file.", isRekord=".isRekord($file));    
...
window.location.href="_menuNEW.php?dir=<?=$dir;?>&noreload="+noreload;
}
...
window.location.href="_menuNEW.php?dir="+dir+"&goback="+goback+"&"+actionParm+noreload;
}
