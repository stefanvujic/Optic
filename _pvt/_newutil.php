...
<tr><td colspan=2 align=center><input class='btn login' name='login' type=button name='login' value='Login'<?=$movers;?>></td></tr>
...
<script>
  ...
  $(document).load(function() {
    var user = sessionStorage.getItem('user_data');
...
function logout(){
  ...
  <script>
    ...
    sessionStorage.removeItem("blend");
    sessionStorage.removeItem("dbData");
    sessionStorage.removeItem("opacity2");
    sessionStorage.removeItem("cssFilters");
    sessionStorage.removeItem("user_data");
