...
<tr><td colspan=2 align=center><input class='btn' name='login' type=submit name='login' value='Login'<?=$movers;?>></td></tr>

<tr><td colspan=2 align=center><div style='height:8px;'></div></td></tr>

<tr><td colspan=2 align=center><input type='button' class='register' class='btn' name='register' value=' Create New Account'<?=$movers;?>></td></tr>
...
<script>
  // if user clicks on the register button then show the registration fields and hide the login fields
...
// $_SESSION["loginpath"]="https://jdb.ywv.mybluehost.me/optic-cdf26213a150dc3ecb610f18f6b38b46/_pwt/ajax-controller.php";
