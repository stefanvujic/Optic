...
<?
switch($page){
 case 'saverekord': saverekord();   break;
...
<td><input name=pw type=text value='<?=$pw;?>' style='width:200px;'></td>
</tr>
...
<tr><td colspan=2 align=center><input class='btn' name=subbtn type=submit value=' Create New Account ' <?=$movers;?>></td></tr>
</TABLE>
</center>
<?
}
