...
<link rel="icon" href="<?=$gRoot;?>favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="<?=$gRoot;?>favicon.ico" type="image/x-icon" />
...
.slider > .dragger {
  background: #99ccff;
  background: -webkit-linear-gradient(top, #99ccff, #6699cc);
  background: -moz-linear-gradient(top, #99ccff, #6699cc);
  background: linear-gradient(top, #99ccff, #6699cc);
...
.slider > .dragger:hover {
  background: -webkit-linear-gradient(top, #99ccff, #336699);
}
...
.radio {
	...
	margin: 0 0 3px;
	padding: 0 0 0 0px;
	background: url("/_pvt/_pvt_images/checkbox/radio.png");
...
<BODY id=iBody onload="onLoad()" onresize='try{gPic.unDoing=1;gToolbar.resize();gPic.repaintAllSizes();gPic.unDoing=0;}catch(e){}'  onkeydown="gToolbar.fKey(1,event.keyCode,event);" style="font-family:economica; color:black; overflow:hidden; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -o-user-select: none; user-select: none;">
<?
...
<DIV style='position:absolute;top:48px;right:0px;'>
	...
	<!-- @@@
	<img class=c_barbtn src='_pvt_images/home.png' onclick='parent.loadHome()' title='go home' style='position:absolute;top:39px;right:229px;width:20px;height:20px;'>
	<img class='c_barbtn' onclick="gPic.lastDesktopColor=gPic.desktopColor;CP.open(window,gPic.desktop,'frameColor',_getLeftClick(event)-95,_getTopClick(event)+10,gPic.viewDesktopColor,0,gPic.desktopColor);"' src='_pvt_images/color.gif' style='position:absolute;top:36px;right:167px;width:24px;height:26px;' title='view background color'>
...
<!--
 <tr id=iSpinHdr style="DISPLAY:;"><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=perSPIN  type="text" data-slider="true" data-slider-range="-180,180" value="0" data-slider-step="1" onchange="gToolbar.chgD3Mode(0);gToolbar.setVars('2drot',this.value,0)"  /></td>
...
<!--
 <tr id=iTiltHdr style="DISPLAY:;"><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=picSWIVXY  type="text" data-slider="true" data-slider-range="-90,90" value="0" data-slider-step="1" onchange="gToolbar.chgD3Mode(0);gToolbar.setVars('swivel',this.value,this.value)" /></td>
  ...
  <tr>
   <td colspan=3>
    ...
    <tr><td width=30></td><td width=70 class="xAxis" >&nbsp;&nbsp;Horizontal&nbsp;</td> <td><input id=picSWIVX  type="text" data-slider="true" data-slider-range="-90,90" value="0" data-slider-step="1" onchange="gToolbar.chgD3Mode(0);gToolbar.setVars('swivel',this.value,null)" /></td></tr>
    <tr><td width=30></td><td class="xAxis">&nbsp;&nbsp;Vertical&nbsp;</td>          <td><input id=picSWIVY  type="text" data-slider="true" data-slider-range="-90,90" value="0" data-slider-step="1" onchange="gToolbar.chgD3Mode(0);gToolbar.setVars('swivel',null,this.value)" /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<TABLE id='iDebugTools' cellspacing=0 cellpadding=0 style='width:100%;position:relative;top:6px;left:10px;'>
 ...
 <td><input class=dbgbtn type=button value="  Speak!   "   onclick="test2(_obj('dbgxTxt1').value)"></td>
 </tr><tr>
...
//msg("setVal "+n+"="+v);
try{$("#"+n).simpleSlider("setValue",v);}catch(e){_obj(n).value=v;}
//try{_obj(n).value=v;}catch(e){}
}
...
if(k>36&&k<41){    
	...
	if(gEmbedded && mode==null)mode=gPic.mousemode.toLowerCase();
	else{
		if(ctrl && shift)	mode="skew";
		else if(ctrl)		mode="panel";
		else if(shift)		mode="fold";
	 	else 				mode="turn";
	}
	switch(mode){
