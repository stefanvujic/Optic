...
var gStartTimeTaken=Date.now()*1;
...
/* ==============================================================================  */
/*! jQuery UI - v1.9.2 - 2012-11-23 ( trimmed down from _pvt/_pvt_css/_pixi.css )  */
...
.radio { padding-right:3px; cursor:pointer; }
...
<BODY id=iBody onload="onLoad()" 
	onresize='try{gPic.unDoing=1;gToolbar.resize();gPic.repaintAllSizes();gPic.unDoing=0;}catch(e){}'  
	onkeydown="gToolbar.fKey(1,event.keyCode,event);" 
	oncontextmenu="return false;" 
	onmouseup="gPic.md=0; gPic.mousemoved=0;" 
	style="font-family:economica; color:black; overflow:hidden; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -o-user-select: none; user-select: none;">
<?
...
<!-- ----- Top Msg ----- -->
<DIV id=topMsg  style='display:none;background:white;position:absolute;left:200px;top:200px;height:60px;color:black;z-index:9991;padding:20px;'>
</DIV>


<!-- ----- Handles ----- -->
<DIV id=iBoxBdrTop class='corners4' onmousedown='iDragBoxMouseDown(event)' style='display:none;overflow:hidden;position:absolute;left:0px;top:0px;height:26px;color:<?=$scrollfgcolor;?>;background:<?=$scrollbgcolor;?>;z-index:9991; cursor:move;'> 
	...
	<TABLE cellpadding=0 cellspacing=0 style='position:absolute;top:2px;right:2px;color:<?=$scrollfgcolor;?>;background:<?=$scrollbgcolor;?>;'><tr>
...
<DIV id=iBoxBdrRight  style='display:none;position:absolute;left:0px;top:0px;width:5px;  background:<?=$scrollbgcolor;?>;z-index:9991;'></DIV>
<DIV id=iBoxBdrLeft   style='display:none;position:absolute;left:0px;top:0px;width:5px;  background:<?=$scrollbgcolor;?>;z-index:9991;'></DIV>
<DIV id=iBoxBdrBottom style='display:none;position:absolute;left:0px;top:0px;height:5px; background:<?=$scrollbgcolor;?>;z-index:9991;'></DIV>
<IMG id=iDragBtn      onmousedown='iDragBtnMouseDown(event)' style='display:none;position:absolute;left:0px;top:0px;height:26px; width:26px; z-index:9991; cursor:move;' src='_pvt_images/handle_resize.png'>
...
<DIV style='position:absolute;top:48px;right:0px;'>
	...
	<img class='c_barbtn corners4' onclick='gToolbar.reset()' style='position:absolute;top:3px;right:224px;width:30px;height:30px;' src='_pvt_images/reset.png' title='reset layer'>
	...
	<img id=iLockZindexPadlock src="_pvt_images/Lock-Lock.png" onclick="gToolbar.flipLockZindex(null,1)" style="cursor:pointer;position:absolute;top:7px;right:137px;width:18px;" title="lock layer overlaps">
	<img id=iHideImageEye src="_pvt_images/hideOn.png" onclick="gToolbar.hideImage()" style="cursor:pointer;position:absolute;top:9px;right:103px;width:18px;" title="hide image">
...
<tr>
	...
	<!-- <td><input id=iBlend type="range"  min="0,15" value="0" step="1" oninput="gToolbar.setBlend(this.value)" /></td> -->
	<td><input id=iBlend style="height:40px;" type="range" min="0" max="15" value="0" oninput="gToolbar.setBlend(this.value)" /></td>
	<td></td>
...
<DIV style="height:20px;">
	<TABLE cellpadding=0 cellspacing=0 style="width:100%;">
		...
		<td><input id=fil_sat type="range" min="0" max="500" value="100" step="1" oninput="gToolbar.setVars('saturate',this.value,0,1)" /></td>
		<td>&nbsp;&nbsp;</td>
...
<tr id=iColorTable style='display:none;'><td colspan=2>
   ...
   <tr><td width=30></td>	<td width=70>Brightness</td>			<td><input id=fil_bri  type="range" min="30" max="500" value="100" step="1" oninput="gToolbar.setVars('brightness',this.value,0,1)" /></td>	<td></td></tr>
   <tr><td></td>			<td>Contrast</td>						<td><input id=fil_con  type="range" min="30" max="500" value="100" step="1" oninput="gToolbar.setVars('contrast',this.value,0,1)" /></td>	<td></td></tr>
   <tr><td></td>			<td>Blur</td>							<td><input id=fil_blu  type="range" min="0" max="20" value="0" step="1" oninput="gToolbar.setVars('blur',this.value,0,1)" /></td>			<td></td></tr>
   <tr><td></td>			<td>Hue</td>							<td><input id=fil_hue  type="range" min="0" max="360" value="0" step="1" oninput="gToolbar.setVars('hue-rotate',this.value,0,1)" /></td>		<td></td></tr>
   <tr><td></td>			<td>Sepia</td>							<td><input id=fil_sep  type="range" min="0" max="100" value="0" step="1" oninput="gToolbar.setVars('sepia',this.value,0,1)" /></td>			<td></td></tr>
   <tr><td></td>			<td>Grayscale</td>						<td><input id=fil_gra  type="range" min="0" max="100" value="0" step="1" oninput="gToolbar.setVars('grayscale',this.value,0,1)" /></td>		<td></td></tr>
   <tr><td></td>			<td>Invert</td>							<td><input id=fil_inv  type="range" min="0" max="100" value="0" step="1" oninput="gToolbar.setVars('invert',this.value,0,100)" /></td>		<td></td></tr>
   <tr><td></td>			<td>Opacity</td>						<td><input id=opcXY    type="range" min="0" max="1" value="1" step="0.1" oninput="gToolbar.setVars('opacity2',this.value,0,1)" /></td>			<td></td></tr>
	...
	<TABLE cellspacing=0 cellpadding=0 border=0 style='width:100%;'>
			...
			<tr id=iMaskTable style='display:none;'><td colspan=2>
				 ...
				 <td colspan=4>
					  <TABLE cellpadding=0 cellspacing=0>
						  ...
						  <td>Start&nbsp;</td> 
						  <td width=41></td>
						  <td><input id=mskStart type="range" min="-25" max="100" value="40" step="0.2" oninput="gToolbar.chgMask()" /><td>
						  <td width=6></td>
						  <td></td>
						  </tr>
						  ...
						  <td>Blur&nbsp;</td> 
						  <td width=41></td>
						  <td><input id=mskBlur type="range" min="0" max="150" value="20" step="0.2" oninput="gToolbar.chgMask()" /><td>
						  <td width=6></td>
						  <td></td>
						  </tr>
				 ...
				 <tr><td colspan=4>
				  	  <TABLE cellpadding=0 cellspacing=0 style="width:100%;">
				 		<tr><td width=50></td>	<td>Solid?&nbsp;</td>	<td><input id=mskSolid onchange="gToolbar.chgMask()" type="checkbox">&nbsp;</td><td><input id=mskSolidAlpha type="range"  min="0,255" value="128" step="1" oninput="gToolbar.chgMask()" /></td></tr>
				 		<tr><td width=50></td>	<td>Red			</td>	<td></td> <td><input id=mskRed   type="range"  min="-255" max="255" value="0" step="1" oninput="gToolbar.chgMask()" /></td></tr>
				 		<tr><td width=50></td>	<td>Green		</td>	<td></td> <td><input id=mskGreen type="range"  min="-255" max="255" value="0" step="1" oninput="gToolbar.chgMask()" /></td></tr>
				 		<tr><td width=50></td>	<td>Blue		</td>	<td></td> <td><input id=mskBlue  type="range"  min="-255" max="255" value="0" step="1" oninput="gToolbar.chgMask()" /></td></tr>
				 	  </TABLE>
				 </td></tr>
				 </TABLE>
			</td></tr>
		...
		<tr id=iPosterizeHdr><td colspan=2>
			...
			<tr id=iPosterizeTable style='display:none;'><td>
			 	<TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
					<tr><td width=40></td><td class=xAxis>Radius</td><td width=20></td><td><input id=iPosterizeRadius type="range"  min="2" max="200" value="64" step="1" oninput="gToolbar.chgPosterize(1)" /></td></tr>
					<!-- intensity behaves exactly like 'brightness' so not needed -->
					<tr style="DISPLAY:NONE;"><td width=40></td><td class=xAxis>Intensity</td><td width=20></td><td><input id=iPosterizeIntensity type="range"  min="2" max="200" value="64" step="1" oninput="gToolbar.chgPosterize(0)" /></td></tr>
				</TABLE>
			</td></tr>
			</TABLE>
		</td></tr>
		...
		<tr id=iColorRgbHdr><td colspan=2>
			...
			<tr id='iColorRgbTable' style='display:none;'><td>
			  	<TABLE cellpadding=0 cellspacing=0>
			 		<tr><td width=40></td><td class=xAxis width=60>Red</td>		<td><input id=colorRgbRed   type="range"  min="-255" max="255" value="0" step="1" oninput="gToolbar.chgColorRgb()" /></td></tr>
			 		<tr><td width=40></td><td class=xAxis width=60>Green</td>	<td><input id=colorRgbGreen type="range"  min="-255" max="255" value="0" step="1" oninput="gToolbar.chgColorRgb()" /></td></tr>
			 		<tr><td width=40></td><td class=xAxis width=60>Blue</td>	<td><input id=colorRgbBlue  type="range"  min="-255" max="255" value="0" step="1" oninput="gToolbar.chgColorRgb()" /></td></tr>
			 	</TABLE>
			</td></tr>
		 	</TABLE>
		</td></tr>
		...
		<tr id=iSwapColorsHdr><td colspan=2>
			...
			<tr id='iSwapColorsTable' style='display:none;'><td>
			  	<TABLE cellpadding=0 cellspacing=0>
			 		...
			 		<tr><td width=40></td><td class=xAxis width=60>Opacity</td><td><input id=iSwapColorsAlpha type="range"  min="0" max="255" value="255" step="1" oninput="gToolbar.chgSwapColors()" /></td><td></td></tr>
			 		<tr><td width=40></td><td class=xAxis width=60>Tolerance</td><td><input id=iSwapColorsTolerance type="range"  min="0" max="255" value="10" step="1" oninput="gToolbar.chgSwapColors()" /></td><td></td></tr>
		...
		<tr id=iOilPaintHdr><td colspan=2>
			...
			<tr id=iOilPaintTable style='display:none;'><td>
			 	<TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
					<tr><td width=40></td><td class=xAxis>Radius</td><td width=20></td><td><input id=iOilPaintRadius type="range"  min="2" max="10" value="4" step="1" oninput="gToolbar.chgOilPaint()" /></td></tr>
					<tr><td width=40></td><td class=xAxis>Intensity</td><td width=20></td><td><input id=iOilPaintIntensity type="range"  min="1" max="200" value="55" step="1" oninput="gToolbar.chgOilPaint()" /></td></tr>
				</TABLE>
			</td></tr>
			</TABLE>
		</td></tr>
		...
		<tr id=iFillColorHdr><td colspan=2>
			...
			<tr id='iFillColorTable' style='display:none;'><td>
			  	<TABLE cellpadding=0 cellspacing=0>
					...
					<!--
			 		<tr><td width=40></td><td class=xAxis width=60>Opacity</td><td><input id=iFillColorAlpha type="range"  min="0,255" value="255" step="1" oninput="gToolbar.updFillColor();gToolbar.hiliteFCbtn(1)" /></td></tr>
			 		<tr><td width=40></td><td class=xAxis width=60>Tolerance</td><td><input id=iFillColorTolerance type="range"  min="0,200" value="15" step="1" oninput="gToolbar.updFillColor();gToolbar.hiliteFCbtn(1)" /></td></tr>
					...
					-->
			 		<tr><td width=40></td><td class=xAxis width=60>Opacity</td><td><input id=iFillColorAlpha type="range"  min="0" max="255" value="255" step="1" oninput="gToolbar.updFillColor();gPic.screen.applyFillColor()" /></td></tr>
			 		<tr><td width=40></td><td class=xAxis width=60>Tolerance</td><td><input id=iFillColorTolerance type="range"  min="0" max="200" value="15" step="1" oninput="gToolbar.updFillColor();gPic.screen.applyFillColor()" /></td></tr>
...
<div style="height:20px;">
  <TABLE cellspacing=0 cellpadding=0 style='width:100%;'><tr>
   ...
   <td><input id=imgXY type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('image',this.value,this.value);" /></td>
...
<tr id=iImageTable style='display:none;'><td colspan=2>
 <TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
  <tr><td colspan=2>
  <TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
 	<tr><td width=30></td><td width=70  class="xAxis">Horizontal</td>  <td><input id=imgX  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('image',this.value,null)" /></td></tr>
  	<tr><td></td><td class="xAxis">Vertical&nbsp;&nbsp;&nbsp;</td>  <td><input id=imgY  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('image',null,this.value)" /></td></tr>
  	<tr style="DISPLAY:NONE;"><td></td><td class="xAxis">&nbsp;&nbsp;Width&nbsp;</td>   <td><input id=strX  type="range"  min="0" max="100" value="50" step="1" oninput="gToolbar.setVars('stretch',this.value,null)" /></td></tr>
  	<tr style="DISPLAY:NONE;"><td></td><td class="xAxis">&nbsp;&nbsp;Height&nbsp;</td>   <td><input id=strY  type="range"  min="0" max="100" value="50" step="1" oninput="gToolbar.setVars('stretch',null,this.value)" /></td></tr>
    </TABLE>
  </td></tr>
 </TABLE>
</td></tr>
...
<div style="height:20px;">
  <TABLE cellspacing=0 cellpadding=0 style='width:100%;'><tr>
   ...
   <td><input id=splXY type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('split',this.value,this.value);" /></td>
   <td><img class=resetbtn src='_pvt_images/reset.png' onclick="gToolbar.setVars('split',50,50);gToolbar.syncControls();" ></td>
  </tr>
  </TABLE>
</div>
</td></tr>
<tr id=iPanelTable style='display:none;'><td colspan=2>
 <TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
  <tr><td colspan=2>
     <TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
  	 <tr><td width=30></td><td width=70  class="xAxis">&nbsp;&nbsp;Horizontal</td>  <td><input id=splX  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('split',this.value,null)" /></td></tr>
  	 <tr><td></td><td class="xAxis">&nbsp;&nbsp;Vertical</td>  <td><input id=splY  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('split',null,this.value)" /></td></tr>
     </TABLE>
  </td></tr>
  <tr><td colspan=2>
...
<!-- ---------------------------- PanelSkew ---------------------------------->
 <tr id=iPanelSkewHdr><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=perPanelSKXY type="range"  min="-90" max="90" value="0" step="1" oninput="gToolbar.setVars('panelskew',this.value,this.value,0);"  /></td>
  ...
  <tr>
   <td colspan=3>
    ...
    <tr><td width=30></td><td width=70  class="xAxis">&nbsp;&nbsp;Horizontal</td>   <td><input id=perPanelSKX type="range"  min="-90" max="90" value="0" step="1" oninput="gToolbar.setVars('panelskew',this.value,null,0);"  /></td></tr>
    <tr><td width=30></td><td  class="xAxis">&nbsp;&nbsp;Vertical</td>   <td><input id=perPanelSKY type="range"  min="-90" max="90" value="0" step="1" oninput="gToolbar.setVars('panelskew',null,this.value,0);"  /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<div style="height:20px;">
  <TABLE cellspacing=0 cellpadding=0 style='width:100%;'><tr>
   ...
   <td><input id=fldXY type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('fold',this.value,this.value);" /></td>
...
<tr id=iFoldTable style='display:none;'><td colspan=2>
 <TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
  <tr><td colspan=2>
  <TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
  	<tr><td width=30></td><td width=70 class="xAxis">&nbsp;&nbsp;Horizontal</td>   <td><input id=fldX  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('fold',this.value,null)" /></td></tr>
  	<tr><td></td><td class="xAxis">&nbsp;&nbsp;Vertical&nbsp;</td>   <td><input id=fldY  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('fold',null,this.value)" /></td></tr>
    </TABLE>
  </td></tr>
 </TABLE>
</td></tr>
...
<!-- ---------------------- Zoom --------------------------->
 <tr id=iZoomHdr><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=zomXY type="range"  min="1" max="1000" value="500" step="2" oninput="gToolbar.setVars('zoom',this.value,this.value)" /></td>
  ...
  <tr>
   <td colspan=3>
    ...
    <tr><td width=30></td><td width=70 class="xAxis" >&nbsp;&nbsp;Width&nbsp;</td> <td><input id=zomX  type="range"  min="1" max="1000" value="500" step="2" oninput="gToolbar.setVars('zoom',this.value,null)" /></td></tr>
    <tr><td width=30></td><td class="xAxis">&nbsp;&nbsp;Height&nbsp;</td>          <td><input id=zomY  type="range"  min="1" max="1000" value="500" step="2" oninput="gToolbar.setVars('zoom',null,this.value)" /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<!-- --------------------- Slide ---------------------->
 <tr id=iSlideHdr><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=sldXY type="range"  min="-150" max="250" value="50" step="1" oninput="gToolbar.setVars('slide',this.value,this.value,1)" /></td>
  ...
  <tr>
   <td colspan=3>
    ...
    <tr><td width=30></td><td  width=70 class="xAxis">&nbsp;&nbsp;Horizontal&nbsp;</td>         <td><input id=sldX  type="range"  min="-150" max="250" value="50" step="1" oninput="gToolbar.setVars('slide',this.value,null,1)" /></td></tr>
    <tr><td width=30></td><td class="xAxis"  width=70>&nbsp;&nbsp;Vertical&nbsp;</td>         <td><input id=sldY  type="range"  min="-150" max="250" value="50" step="1" oninput="gToolbar.setVars('slide',null,this.value,1)" /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<!-- ------------------------ Size --------------------------------->
 <tr id=iResizeHdr><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=rszXY class=slider type="range"  min="1" max="400" value="100" step="1" oninput="gToolbar.setXYSizes(this.value)" /></td>
  ...
  <tr>
   <td colspan=4>
      ...
      <tr><td width=70 class="xAxis">Width</td> <td><input id=rszX type="range"  min="1" max="400" value="100" step="1" oninput="gToolbar.setVars('size',this.value,null)" /></td></tr>
      <tr><td class="xAxis">Height</td> <td><input id=rszY type="range"  min="1" max="400" value="100" step="1" oninput="gToolbar.setVars('size',null,this.value)" /></td></tr>
...
<!-- ------------------------ Move --------------------------------->
 <tr id=iMoveHdr><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=movXY class=slider type="range"  min="-30" max="30" value="0" step="1" oninput="gToolbar.setVars('move',this.value,this.value,1)" /></td>
  ...
  <tr>
   <td colspan=4>
      ...
      <tr><td width=70 class="xAxis">Left</td>   <td><input id=movX  type="range"  min="-30" max="30" value="0" step="1" oninput="gToolbar.setVars('move',this.value,null,1)" /></td></tr>
      <tr><td class="xAxis">Top</td>   <td><input id=movY  type="range"  min="-30" max="30" value="0" step="1" oninput="gToolbar.setVars('move',null,this.value,1)" /></td></tr>
      </TABLE>
   </td>
  </tr>
  <tr><td colspan=4 style='height:6px;'></td></tr>
...
<!--
 <tr id=iSpinHdr style="DISPLAY:;"><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=perSPIN  type="range"  min="-180,180" value="0" step="1" oninput="gToolbar.chgD3Mode(0);gToolbar.setVars('2drot',this.value,0)"  /></td>
...
<!--
 <tr id=iTiltHdr style="DISPLAY:;"><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=picSWIVXY  type="range"  min="-90,90" value="0" step="1" oninput="gToolbar.chgD3Mode(0);gToolbar.setVars('swivel',this.value,this.value)" /></td>
  ...
  <tr>
   <td colspan=3>
    ...
    <tr><td width=30></td><td width=70 class="xAxis" >&nbsp;&nbsp;Horizontal&nbsp;</td> <td><input id=picSWIVX  type="range"  min="-90,90" value="0" step="1" oninput="gToolbar.chgD3Mode(0);gToolbar.setVars('swivel',this.value,null)" /></td></tr>
    <tr><td width=30></td><td class="xAxis">&nbsp;&nbsp;Vertical&nbsp;</td>          <td><input id=picSWIVY  type="range"  min="-90,90" value="0" step="1" oninput="gToolbar.chgD3Mode(0);gToolbar.setVars('swivel',null,this.value)" /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<!-- ---------------------- Turn --------------------------->
 <tr id=iTurnHdr><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=turnXY  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('turn',this.value,this.value)" /></td>
  ...
  <tr>
   <td colspan=3>
    ...
    <tr><td width=30></td><td width=70 class="xAxis" >&nbsp;&nbsp;Horizontal&nbsp;</td> <td><input id=turnX  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('turn',this.value,null)" /></td></tr>
    <tr><td width=30></td><td class="xAxis">&nbsp;&nbsp;Vertical&nbsp;</td>          <td><input id=turnY  type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('turn',null,this.value)" /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
<tr>
	<td><div style="height:24px;"><span id=iFrameTxt class=toolcontrolHdr onclick="gToolbar.expandFrameTools();">&nbsp;Frame</span></div></td>
	<td align=right><img class=resetbtn src='_pvt_images/reset.png' onclick="gToolbar.resetFrame()"></td>
</tr>
...
<tr id=iShadowsHdr><td colspan=2>
	...
	<tr><td colspan=2>
	  	...
	  	<TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
			...
			<td class=toolControl onclick="gToolbar.expandShadows()" style='width:60px;'>Shadows&nbsp;&nbsp;</td>
			<td style='width:30px;'><input id=shdON onchange="gToolbar.applyShadows()" type=checkbox checked style="position:relative;top:0px;"></td>
			<td class=xAxis align=left>
				<img src="_pvt_images/color.gif" onclick="CP.open(window,gPic.screen.div,'shadowColor',_getLeftClick(event)-150,_getTopClick(event)+10,gToolbar.setShadowColor,1,gToolbar.getShadowHexColor(gPic.screen));" style='cursor:pointer;position:relative;top:0px;'>
			</td>
	  		<td align=right>
			...
			<td align=right><img class=resetbtn src='_pvt_images/reset.png' onclick="gToolbar.resetShadows(gPic.screen)"></td>
			</tr>
		</TABLE>
	...
	<tr><td colspan=2>
		 <TABLE id=iShadowsTable cellspacing=0 cellpadding=0 style='display:none;width:100%;'>
			<tr><td></td><td  width=60 class="xAxis">Spread</td><td><input   id=shdS type="range"  min="0" max="800" value="0" step="1" oninput="gToolbar.applyShadows()"  /></td></tr>
			<tr><td></td><td  class="xAxis">Blur</td><td><input id=shdB type="range"  min="0" max="1000" value="20" step="2" oninput="gToolbar.applyShadows()"  /></td></tr>
			<tr><td></td><td  class="xAxis">X-Offset</td><td><input id=shdX type="range"  min="-400" max="400" value="0" step="1" oninput="gToolbar.applyShadows()" /></td></tr>
			<tr><td></td><td  class="xAxis">Y-Offset</td><td><input id=shdY type="range"  min="-400" max="400" value="0" step="1" oninput="gToolbar.applyShadows()"  /></td></tr>
			<tr><td></td><td  class="xAxis">Opacity</td> <td><input id=shdO type="range"  min="0" max="1" value="1" step="0.1" oninput="gToolbar.applyShadows()" /></td></tr>
	...
	<tr><td colspan=2><div style='height:8px;overflow:hidden;'></div></td></tr>
  ...
  <TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
  	<tr><td>
	  	<TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
			<tr>
	  		<td style='width:18px;'></td>
			<td class=toolControl onclick="gToolbar.expandBackground()" style='width:97px;'>Background&nbsp;&nbsp;</td>
			<td><img id=iFrameColorImg src="_pvt_images/color.gif" onclick="gPic.screen.oldFrameColor=gPic.screen.frameColor;CP.open(window,gPic.screen.frame,'frameColor',_getLeftClick(event)-95,_getTopClick(event)+10,gToolbar.setFrameColor,0,gPic.screen.frameColor);" style='cursor:pointer;position:relative;top:2px;' title='flat background'></td>
			</tr>
		</TABLE>
  	</td></tr>
  	...
  	<tr><td>
		...
		<tr><td>
		  	<TABLE id=iGradientTable cellspacing=0 cellpadding=0 style='width:100%;'>
		  		<tr><td width=30></td><td width=70>Direction&nbsp;</td> <td><input id=grdP type="range"  min="1" max="5" value="5" step="1" oninput="gToolbar.applyGradient()"  /></td><td></td></tr>
		  		<tr><td width=30></td><td width=70>Color1&nbsp;</td>   <td><input id=grdC2 type="range"  min="0" max="100" value="100" step="1" oninput="gToolbar.applyGradient()"  /><td><img src="_pvt_images/color.gif" onclick="gPic.screen.oldGradient=gPic.screen.gradient;CP.open(window,gPic.screen.div,'gradientColor',_getLeftClick(event)-95,_getTopClick(event)+10,gPic.screen.setGradientColor1,0,gPic.screen.getGradColor1());" style='cursor:pointer;'></td></tr>
		  		<tr><td width=30></td><td width=70>Color2&nbsp;</td>   <td><input id=grdC1 type="range"  min="0" max="100" value="0" step="1" oninput="gToolbar.applyGradient()"  /><td><img src="_pvt_images/color.gif" onclick="gPic.screen.oldGradient=gPic.screen.gradient;CP.open(window,gPic.screen.div,'gradientColor',_getLeftClick(event)-95,_getTopClick(event)+10,gPic.screen.setGradientColor2,0,gPic.screen.getGradColor2());" style='cursor:pointer;'></td></tr>
		  	</TABLE>
		</td></tr>
		</TABLE>
  	</td></tr>
...
<tr id=iShapeHdr style="DISPLAY:;"><td colspan=2>
	<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
		...
		<TABLE cellpadding=0 cellspacing=0 style='width:100%;'><tr>
			...
			<td><input  id=shdR type="range"  min="0" max="100" value="0" step="1" oninput="gToolbar.applyCorners()"  /></td>
...
<tr id=iOpacityHdr style="DISPLAY:;"><td colspan=2>
  	<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
	  	<tr><td width=20></td><td width=80 class=toolControlBold>Opacity</td><td><input id=opcDV type="range"  min="0" max="1" value="1" step="0.1" oninput="gToolbar.setVars('opacity1',this.value,0,1)" /></td>
			<td></td><td style='width:15px;'></td></tr>
...
<tr id=iViewZoomHdr style="DISPLAY:NONE;"><td colspan=2>
  	<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
	  	<tr>
			...
			<td><input id=iViewZoom type="range"  min="1" max="1000" value="100" step="1" oninput="gPic.viewSetVars('viewzoom',this.value,null)" /></td>
...
<tr id=iViewSlideHdr style="DISPLAY:NONE;"><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=sldViewXY type="range"  min="-500" max="500" value="0" step="1" oninput="gPic.viewSetVars('viewslide',this.value,this.value)" /></td>
  ...
  <tr>
   <td colspan=3>
	...
	<td><input id=sldViewX  type="range"  min="-500" max="500" value="0" step="1" oninput="gPic.viewSetVars('viewslide',this.value,null)" /></td></tr>
    <tr><td width=26></td><td class="xAxis"  width=70>&nbsp;&nbsp;Vertical&nbsp;</td>
	 <td><input id=sldViewY  type="range"  min="-500" max="500" value="0" step="1" oninput="gPic.viewSetVars('viewslide',null,this.value)" /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<tr id=iViewSpinHdr style="DISPLAY:NONE;"><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=iViewSpin  type="range"  min="-180" max="180" value="0" step="1" oninput="gPic.viewSetVars('view2drot',this.value,0)"  /></td>
...
<tr id=iViewTiltHdr style="DISPLAY:NONE;"><td colspan=2>
  ...
  <tr>
   ...
   <td><input id=iViewTilt  type="range"  min="-90" max="90" value="0" step="1" oninput="gPic.viewSetVars('viewswivel',this.value,this.value)" /></td>
  ...
  <tr>
   <td colspan=3>
    ...
    <tr><td width=30></td><td width=70 class="xAxis" >&nbsp;&nbsp;Horizontal&nbsp;</td><td><input id=iViewTiltX  type="range"  min="-90" max="90" value="0" step="1" oninput="gPic.viewSetVars('viewswivel',this.value,null)" /></td></tr>
    <tr><td width=30></td><td class="xAxis">&nbsp;&nbsp;Vertical&nbsp;</td>            <td><input id=iViewTiltY  type="range"  min="-90" max="90" value="0" step="1" oninput="gPic.viewSetVars('viewswivel',null,this.value)" /></td></tr>
    </TABLE>
   </td>
  </tr>
  <tr><td colspan=3 style='height:6px;'></td></tr>
...
<tr>
	...
	<td><input id=iViewBlend type="range"  min="0" max="15" value="0" step="1" oninput="gPic.viewSetVars('viewblend',this.value)" /></td>
...
<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
	...
	<TABLE cellpadding=0 cellspacing=0 style="width:100%;">
		...
		<td><input id=viewfil_sat type="range"  min="0" max="500" value="100" step="1" oninput="gPic.viewSetVars('saturate',this.value,0,1)" /></td>
	...
	<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
	   <tr><td width=30></td>	<td width=70>Brightness</td>			<td><input id=viewfil_bri  type="range"  min="30" max="200" value="100" step="1" oninput="gPic.viewSetVars('brightness',this.value,0,1)" /></td></tr>
	   <tr><td></td>			<td>Contrast</td>						<td><input id=viewfil_con  type="range"  min="30" max="500" value="100" step="1" oninput="gPic.viewSetVars('contrast',this.value,0,1)" /></td></tr>
	   <tr><td></td>			<td>Blur</td>							<td><input id=viewfil_blu  type="range"  min="0" max="20" value="0" step="1" oninput="gPic.viewSetVars('blur',this.value,0,1)" /></td>		</tr>
	   <tr><td></td>			<td>Hue</td>							<td><input id=viewfil_hue  type="range"  min="0" max="360" value="0" step="1" oninput="gPic.viewSetVars('hue-rotate',this.value,0,1)" /></td>	</tr>
	   <tr><td></td>			<td>Sepia</td>							<td><input id=viewfil_sep  type="range"  min="0" max="100" value="0" step="1" oninput="gPic.viewSetVars('sepia',this.value,0,1)" /></td>		</tr>
	   <tr><td></td>			<td>Grayscale</td>						<td><input id=viewfil_gra  type="range"  min="0" max="100" value="0" step="1" oninput="gPic.viewSetVars('grayscale',this.value,0,1)" /></td>	</tr>
	   <tr><td></td>			<td>Invert</td>							<td><input id=viewfil_inv  type="range"  min="0" max="100" value="0" step="1" oninput="gPic.viewSetVars('invert',this.value,0,100)" /></td>	</tr>
	   <tr><td></td>			<td>Opacity</td>						<td><input id=viewopcXY    type="range"  min="0" max="1" value="1" step="0.1" oninput="gPic.viewSetVars('opacity2',this.value,0,1)" /></td>		</tr>
	</TABLE>
	</td></tr>
	<tr><td colspan=2 style='height:6px;'></td></tr>
</TABLE>
  ...
  <TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
  	<tr><td>
	  	<TABLE cellpadding=0 cellspacing=0>
			...
			<td><img id=iviewFrameColorImg src="_pvt_images/color.gif" onclick="gPic.lastDesktopColor=gPic.desktopColor;CP.open(window,gPic.desktop,'frameColor',_getLeftClick(event)-95,_getTopClick(event)+10,gPic.viewDesktopColor,0,gPic.desktopColor);" style='cursor:pointer;position:relative;top:2px;' title='flat background'></td>
			</tr>
		</TABLE>
  	</td></tr>
	<tr><td style='height:4px;'></td></tr>
  	<tr><td>
		...
		<tr><td>
		  	<TABLE id=iviewGradientTable cellspacing=0 cellpadding=0 style='width:100%;'>
		  		<tr><td width=30></td><td width=70>Direction&nbsp;</td> <td><input id=viewgrdP type="range"  min="1" max="5" value="5" step="1" oninput="gToolbar.applyGradient('view')"  /></td><td></td></tr>
		  		<tr><td width=30></td><td width=70>Color1&nbsp;</td>    <td><input id=viewgrdC2 type="range"  min="0" max="100" value="100" step="1" oninput="gToolbar.applyGradient('view')"  /><td><img src="_pvt_images/color.gif" onclick="gPic.oldGradient=gPic.gradient;CP.open(window,gPic.desktop,'gradientColor',_getLeftClick(event)-95,_getTopClick(event)+10,gPic.setGradientColor1,0,gPic.getGradColor1());" style='cursor:pointer;'></td></tr>
		  		<tr><td width=30></td><td width=70>Color2&nbsp;</td>    <td><input id=viewgrdC1 type="range"  min="0" max="100" value="0" step="1" oninput="gToolbar.applyGradient('view')"  /><td><img src="_pvt_images/color.gif" onclick="gPic.oldGradient=gPic.gradient;CP.open(window,gPic.desktop,'gradientColor',_getLeftClick(event)-95,_getTopClick(event)+10,gPic.setGradientColor2,0,gPic.getGradColor2());" style='cursor:pointer;'></td></tr>
		  	</TABLE>
		</td></tr>
		</TABLE>
  	</td></tr>
...
<TABLE id=iTilingHdr cellspacing=0 cellpadding=0 style='width:100%;'>
	...
	<tr><td colspan=2>
		<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
		   	<tr>
				<td width=30></td>
				<td class="xAxis" width=62>Lock X/Y</td>
				<td></td>
				<td width=16></td>
		    ...
		    <tr>
				...
				<td><input id="izxaxis" type="range"  min="1" max="36" value="4" step="1" oninput="_obj('izx').innerHTML=this.value;gToolbar.tileScreen(0)" /></td>
				<td width=16></td>
		    ...
		    <tr>
				...
				<td><input id="izyaxis" type="range"  min="1" max="36"   value="4" step="1" id="izxaxis"="_obj('izy').innerHTML=this.value;gToolbar.tileScreen(1)" /></td>
				<td width=16></td>
		    ...
		    <tr>
				...
				<td><input  id="ixaxis" type="range"  min="1" max="36"  value="4" step="1" oninput="_obj('ixx').innerHTML=this.value;gToolbar.tileScreen(0)" /></td>
				<td width=16></td>
		    ...
		    <tr>
				...
				<td><input  id="iyaxis" type="range"  min="1" max="36"  value="4" step="1" oninput="_obj('iyy').innerHTML=this.value;gToolbar.tileScreen(1)" /></td>
				<td width=16></td>
			...
			<tr>
			    ...
			    <td><input id=frkWH type="range"  min="100" max="400" value="100" step="1" oninput="gToolbar.setVars('frack',this.value,this.value)" /></td>
				<td></td>
	...
	<tr id=iFrackHdr><td colspan=2>
		<TABLE cellspacing=0 cellpadding=0>
			<tr>
			   ...
			   <td><input id=frkWH type="range"  min="100,400" value="100" step="1" oninput="gToolbar.setVars('frack',this.value,this.value)" /></td>
			   <td><img class=resetbtn src='_pvt_images/reset.png' onclick='gToolbar.applyClipRadius(0);gToolbar.setVars("frack",100,100);gToolbar.setVars("scale",0,0);gToolbar.syncControls();'></td>
			</tr>
			<tr>
			   <td colspan=2>
			   <TABLE id=iFrackTable cellspacing=0 cellpadding=0 style='display:none;'>
				    <tr><td width=40></td><td  width=60 class="xAxis">Width</td> <td><input id=frkW type="range"  min="100,400" value="100" step="1" oninput="gToolbar.setVars('frack',this.value,null)" /></td></tr>
				    <tr><td></td><td class="xAxis">Height</td> <td><input id=frkH type="range"  min="100,400" value="100" step="1" oninput="gToolbar.setVars('frack',null,this.value)" /></td></tr>
			   </TABLE>
			   </td>
			</tr>
			<tr><td colspan=2 style='height:8px;'></td></tr>
...
<tr><td>
		...
		<TABLE id=iReplayTable cellspacing=0 cellpadding=0 style='width:100%;' >
			<tr>
				<td width=50 class="toolcontrolHdr" style="color:red;">RePlay</td>
				<td>
			...
			<td colspan=3>
			   	<TABLE  cellspacing=0 cellpadding=0>
					<tr>
		   				<td width=50 class="xAxis">Mode</td>
						<td class="xAxis">Loop&nbsp;</td>	<td><input id=iHisLoop0 name=iRekLoop value=2 onchange="gToolbar.historyLoopMode()" type=radio checked>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td class="xAxis">Once&nbsp;</td>	<td><input id=iHisLoop1 name=iRekLoop value=4 onchange="gToolbar.historyLoopMode()" type=radio>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td class="xAxis">Stop&nbsp;</td>	<td><input id=iHisLoop2 name=iRekLoop value=1 onchange="gToolbar.historyLoopMode()" type=radio></td>
					</tr>
		   		</TABLE>
			</td>
			</tr>
   			...
   			<tr><td colspan=3><div style='height:6px;'></div></td></tr> 
   			<tr><td width=50 class="xAxis">Curve</td><td><input id=iHisCurve type="range"  min="25" max="75" value="50" step="1" oninput="gToolbar.historyPlayCurve(this.value)" /></td><td></td></tr>
   			<tr><td class="xAxis">Pause</td><td><input id=iHistSpeed type="range"  min="0" max="1000" value="250" step="1" oninput="gToolbar.histPlaySpeed(this.value)" /></td><td width=20><input id=iHistSpeedTxt type="text" value="0" onchange="gToolbar.histPlaySpeed(this.value)" style='width:28px;font-size:12px;' /></td></tr>
			<tr id=iHisDeltaTR><td class="xAxis">Delta</td><td><input id=iHistDelta type="range"  min="1" max="50" value="25" step="1" oninput="gToolbar.histPlayDelta(this.value)" /></td><td width=20><input id=iHistDeltaTxt type="text" value="0" onchange="gToolbar.histPlayDelta(this.value)" style='width:28px;font-size:12px;' /></td></tr>
   			<tr><td colspan=3><div style='height:0px;'></div></td></tr>
			<tr style="DISPLAY:;"><td id=iHisMergeTD colspan=3>
   				<TABLE  cellspacing=0 cellpadding=0><tr>
					<td width=53>Merge</td>
   					<td width=22><input id=iHisMerge onchange="gToolbar.setMerge()" type=checkbox style='position:relative;top:2px;'></td>
   					<td></td>
				</tr></TABLE>
			</td></tr>
			<tr style="DISPLAY:;"><td colspan=3>
   				<TABLE  cellspacing=0 cellpadding=0><tr>
					<td width=53>Smooth</td>
   					<td width=22><input id=iHisSmooth onchange="gToolbar.setSmooth()" type=checkbox checked style='position:relative;top:2px;'></td>
				</tr></TABLE>
			</td></tr>
   			<tr><td colspan=3><div style='height:0px;'></div></td></tr>
			<? if($gLoggedIn){ ?>
			<tr id=iSaveHisBtn><td colspan=3 align=right class="xAxisBold">Save RePlay Action&nbsp;&nbsp;<img class='c_barbtn'  style='position:relative;top:8px;width:28px;height:28px;opacity:0.7;' src='_pvt_images/save1.png' onclick='parent.saveReplay()'  title='save Action'></td>
			<? } ?>
...
<tr><td>
		<TABLE  id=iAutoPlayTable cellspacing=0 cellpadding=0 style='width:100%;position:relative;top:0px;' >
			...
			<TABLE  cellspacing=0 cellpadding=0 style='DISPLAY:;position:relative;left:0px;'>
   				<tr>
				<td width=40 class=toolcontrolHdr style="color:red;">AutoPlay</td>
				...
				<td width=14></td>
				<td><span id=iMouseModeName class=xAxisBold onclick="parent.gMouseModeMenu.clickMenuBtn(parent._obj('iMouseModeBtn'))" style='color:#6699ff;cursor:pointer;'></span></td>
				<td align=right>&nbsp;<img class='c_barbtn' src="_pvt_images/reset.png" onclick="gToolbar.resetCurrentMode()" style="cursor:pointer;width:22px;height:22px;position:relative;top:2px;" /></td>
				</tr>
			</TABLE>
			</td></tr>
			...
			<td colspan=3>
			   	<TABLE  cellspacing=0 cellpadding=0>
					<tr>
		   				<td width=40 class="xAxis">Mode</td>
						<td class="xAxis">Loop&nbsp;</td>	<td><input id=iAniLoop0 name=iAniLoop value=2 onchange="gToolbar.aniLoopMode()" type=radio checked>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td class="xAxis">Once&nbsp;</td>	<td><input id=iAniLoop1 name=iAniLoop value=4 onchange="gToolbar.aniLoopMode()" type=radio>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td class="xAxis">Stop&nbsp;</td>	<td><input id=iAniLoop2 name=iAniLoop value=1 onchange="gToolbar.aniLoopMode()" type=radio></td>
					</tr>
		   		</TABLE>
			</td>
			</tr>
			...
			<tr><td>
  			<TABLE cellspacing=0 cellpadding=0 style='DISPLAY:;'>
  				<tr><td class="xAxis" width=40>X-Min</td><td><input id=iXAniRangeMin type="range" min="0" max="100" value="40" step="1" oninput="gToolbar.historyRange('Min')" /></td><td><input id=iAniX type=checkbox checked  onchange="gToolbar.aniXchg(this.checked)" style='position:relative;top:9px;left:2px;'></td></tr>
  				<tr><td class="xAxis">X-Max</td><td><input id=iXAniRangeMax  type="range" min="0" max="100" value="60" step="1" oninput="gToolbar.historyRange('Max')" /></td><td></td></td></tr>
   				<tr><td colspan=3><div style='height:4px;'></div></td></tr>
  				<tr><td class="xAxis">Y-Min</td><td><input id=iYAniRangeMin  type="range" min="0" max="100" value="40" step="1" oninput="gToolbar.historyRange('Min')" /></td><td><input id=iAniY type=checkbox checked onchange="gToolbar.aniYchg(this.checked)" style='position:relative;top:9px;left:2px;'></td></tr>
  				<tr><td class="xAxis">Y-Max</td><td><input id=iYAniRangeMax  type="range" min="0" max="100" value="60" step="1" oninput="gToolbar.historyRange('Max')" /></td><td></td></td></tr>
				<tr><td  class="xAxis">Pause</td><td><input id=iAniSpeed type="range"  min="0" max="500" value="0" step="1" oninput="gToolbar.historyPlaySpeed(this.value)" /></td><td width=20><input id=iAniSpeedTxt type="text" value="0" onchange="gToolbar.historyPlaySpeed(this.value)" style='width:28px;font-size:12px;' /></td></tr>
				<tr><td class="xAxis">Delta</td><td><input id=iAniDelta type="range"  min="0.02" max="20" value="0.2" step="0.02" oninput="gToolbar.historyPlayDelta(this.value)" /></td><td width=20><input id=iAniDeltaTxt type="text" value="0" onchange="gToolbar.historyPlayDelta(this.value)" style='width:28px;font-size:12px;' /></td></tr>
  			</TABLE>
 			</td></tr>
			<? if($gLoggedIn){ ?>
...
<!-- ================================= PERSPECTIVE ==================================== -->
<tr id=i3DHdr style="DISPLAY:;"><td colspan=2>
...
<!-- ------------------------------- Tilt ------------------------------------------>
 <tr><td colspan=2>
  ...
  <tr>
   ...
   <td width=45></td>
   <td><input id=perROT  type="range"  min="0" max="360" value="0" step="1" oninput="gToolbar.setVars('2drot',this.value,0)"  /></td>
   <td width=45><?=$lightning;?> onclick="gToolbar.spinSlider(event,'perROT',0,45,90,135,180,225,270,315);gToolbar.setVars('2drot',_obj('perROT').value,0)">&nbsp;</td>
  </tr>
  <tr><td colspan=4 style='height:10px;'></td></tr>
  <tr>
	<td class=xAxis>&nbsp;&nbsp;&nbsp;<span class=xAxisBold>Tilt</span>&nbsp;XY</td>
   	<td></td>
	<td><input id=perSWIVXY type="range"  min="0" max="180" value="0" step="1" oninput="gToolbar.setVars('swivel',this.value,this.value,1);"  /></td>
   <td></td>
  </tr>
  <tr>
	<td class=xAxis>&nbsp;&nbsp;&nbsp;&nbsp;Horizantal</td>
   	<td></td>
	<td><input  id=perSWIVY type="range"  min="0" max="180" value="0" step="1" oninput="gToolbar.setVars('swivel',this.value,null,1)" /></td>
   <td>&nbsp;</td>
  </tr>
  <tr>
	<td class=xAxis>&nbsp;&nbsp;&nbsp;&nbsp;Vertical</td>
   	<td></td>
	<td><input  id=perSWIVX type="range"  min="0" max="180" value="0" step="1" oninput="gToolbar.setVars('swivel',null,this.value,1)" /></td>
   <td>&nbsp;</td>
  </tr>
  <tr><td colspan=4 style='height:10px;'></td></tr>
  <tr>
   ...
   <td></td>
   <td><input id=perR3Dxy type="range"  min="0" max="720" value="360" step="1" oninput="gToolbar.flipBoth(this.value)" /></td>
   <td></td>
  </tr>
  <tr>
   <td class=xAxis>&nbsp;&nbsp;&nbsp;&nbsp;Flip&nbsp;X</td>
   <td></td>
   <td><input id=perR3Dx type="range"  min="-180" max="180" value="0" step="1" oninput="gToolbar.flipHorizontal(this.value)" /></td>
   <td>&nbsp;</td>
  </tr>
  <tr>
   <td class=xAxis>&nbsp;&nbsp;&nbsp;&nbsp;Flip&nbsp;Y</td>
   <td></td>
   <td><input id=perR3Dy type="range"  min="-180" max="180" value="0" step="1" oninput="gToolbar.flipVertical(this.value)" /></td>
   <td>&nbsp;</td>
  </tr>
  <tr style="DISPLAY:;"><!-- doesn't appear to have any effect -->
   <td class=xAxis>&nbsp;&nbsp;&nbsp;&nbsp;Flip&nbsp;Z</td>
   <td></td>
   <td><input id=perR3Dz type="range"  min="-1" max="1" value="0" step="0.1" oninput="gToolbar.setVars('flipz',this.value,0)" /></td>
   <td></td>
  </tr>
  <tr>
   <td class=xAxis>&nbsp;&nbsp;&nbsp;&nbsp;Tilt</td>
   <td></td>
   <td><input id=perSP type="range"  min="-1000" max="0" value="-1000" step="1" oninput="gToolbar.setVars('tilt',this.value,0)" /></td>
   <td></td>
  </tr>
  <tr><td colspan=4 style='height:10px;'></td></tr>
  <tr><td colspan=4>
	...
	<tr><td class="xAxis" width=70>Custom&nbsp;Flip&nbsp;</td><td colspan=2><input id=perR3D type="range"  min="0" max="360" value="0" step="1" oninput="gToolbar.flipCustom(this.value)" /></td></tr>
    <tr><td class="xAxis">&nbsp;x-Axis</td><td colspan=2><input id=perRY  type="range"  min="-180" max="180" value="0" step="1" oninput="gToolbar.setVars('axis',null,this.value)" /></td></tr>
    <tr><td class="xAxis">&nbsp;y-Axis</td><td colspan=2><input id=perRX  type="range"  min="-180" max="180" value="0" step="1" oninput="gToolbar.setVars('axis',this.value,null)" /></td></tr>
    ...
    <tr><td class="xAxis">&nbsp;Origin&nbsp;Offset</td><td colspan=2><input id=perOriginOffset  type="range"  min="-500" max="500" value="0" step="1" oninput="gToolbar.setVars('originoffset',this.value,0)" /></td></tr>
...
-->
		...
		<TABLE cellspacing=0 cellpadding=0  style='width:100%;position:relative;left:6px;'>
			<tr>
			<td class=toolControl  onclick="gToolbar.expandControl(_obj('iBoxesTable'));" width=90>&nbsp;&nbsp;Box Tiling</td><td><input id="ixxy" type="range"  min="1" max="12" value="1" step="1" oninput="_obj('ixy').innerHTML=this.value;gToolbar.tileBoxes()" /></td><td><span class="rangetext" id="ixy">1</span></td>
			</tr>
			<tr><td colspan=3>
				<TABLE id=iBoxesTable style="display:none;">
					<tr><td width=45></td><td class="xAxis" width=55>x-Boxes&nbsp;</td><td><input id="ixxx" type="range"  min="1" max="12" value="1" step="1" oninput="_obj('ix').innerHTML=this.value;gToolbar.tileScreen(null,1)" /></td><td><span class="rangetext" id="ix">1</span></td></tr>
					<tr><td width=45></td><td class="xAxis" width=55>y-Boxes&nbsp;</td><td><input id="iyyy" type="range"  min="1" max="12" value="1" step="1" oninput="_obj('iy').innerHTML=this.value;gToolbar.tileScreen(null,1)" /></td><td><span class="rangetext" id="iy">1</span></td></tr>
				</TABLE>
			</td></tr>
			<tr><td colspan=3 style='height:8px;'></td></tr>
			<tr>
			<td class=toolControlBold width=90>&nbsp;&nbsp;Box Split</td><td><input id=iScaleX  type="range"  min="0" max="100" value="0" step="1" oninput="gToolbar.setVars('scale',this.value,0)" /></td><td></td>
			</tr>
		...
		<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
			...
			<DIV style="height:20px;">
			  ...
			  <tr>
				   ...
				   <td><input id=splZXY type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('warp',this.value,this.value);" /></td>
			...
			<TABLE cellpadding=0 cellspacing=0 style='width:100%;'>
				<tr><td colspan=2>
				<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
					  <tr><td width=30></td><td width=60 class="xAxis">&nbsp;&nbsp;Horizontal&nbsp;</td> <td><input id=splZX type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('warp',this.value,null)" /></td></tr>
				  	  <tr><td width=30></td><td width=60 class="xAxis">&nbsp;&nbsp;Vertical&nbsp;</td> <td><input id=splZY type="range"  min="1" max="99" value="50" step="1" oninput="gToolbar.setVars('warp',null,this.value)" /></td></tr>
				</TABLE>
				</td></tr>
				<tr><td colspan=2>
		...
		<TABLE cellspacing=0 cellpadding=0 style="width:100%;">
			  <tr>
			   ...
			   <td><input id=perSKXY type="range"  min="-90" max="90" value="0" step="1" oninput="gToolbar.setVars('skew',this.value,this.value,1);"  /></td>
			  ...
			  <tr>
			   <td colspan=3>
			    <TABLE id=iSkewTable cellspacing=0 cellpadding=0 style='display:none;'>
				    <tr><td width=40></td><td width=70  class="xAxis">&nbsp;&nbsp;Horizontal</td>   <td><input id=perSKX type="range"  min="-90" max="90" value="0" step="1" oninput="gToolbar.setVars('skew',this.value,null,1);"  /></td></tr>
				    <tr><td width=40></td><td  class="xAxis">&nbsp;&nbsp;Vertical</td>   <td><input id=perSKY type="range"  min="-90" max="90" value="0" step="1" oninput="gToolbar.setVars('skew',null,this.value,1);"  /></td></tr>
			    </TABLE>
			   </td>
			  </tr>
			  <tr><td colspan=3 style='height:6px;'></td></tr>
		...
		<TABLE cellspacing=0 cellpadding=0 style='width:100%;position:relative;left:6px;'>
			<tr>
			<td class=toolControlBold width=92>&nbsp;&nbsp;Clip</td>         <td><input id=clipRadius type="range"  min="0" max="400" value="0" step="1" oninput="gToolbar.applyClipRadius()"  /></td>
			</tr>
			<tr><td colspan=3><div style='height:6px;overflow:hidden;'></div></td></tr>
		</TABLE>
		</td></tr>
...
<!-- ================================= DEBUG ==================================== -->
<tr id=iDebugHdr style="DISPLAY:NONE;"><td colspan=2>
<TABLE cellspacing=0 cellpadding=0 style='width:100%;'>
<tr>
...
<TABLE id='iDebugTools' cellspacing=0 cellpadding=0 style='width:100%;position:relative;top:6px;left:10px;'>
 ...
 <td><input class=dbgbtn type=button value="  Speak!   "   onclick="speak(_obj('iDebugText').value)"></td>
 </tr><tr>
 <td><input class=dbgbtn type=button value=" ?  "   onclick=""></td>
 ...
 <tr style="DISPLAY:;">
 	<td>Show Numbers&nbsp;&nbsp;<input id=inbrs type=checkbox onchange="gToolbar.showNumbers()"></td>
 	<td></td>
 </tr>
 <tr> <td colspan=2><textarea  id="iDebugText" style='width:228px;height:200px;'></textarea></td></tr>
 <tr> <td colspan=2>x:<input type=text id=dbgxTxt1 value=""></td> </tr>
 <tr> <td colspan=2>y:<input type=text id=dbgyTxt2 value=""></td> </tr>  
...
Toolbar.prototype.flipNaturalSize=function(){
var scr=gPic.screen;
scr.naturalSize(1);  
this.configHandles();
this.syncSizes(); 
...
alert("resetRights ever called???");
	_obj("iSaveHisBtn").style.display=(upd)?"":"none";
}
...
var scr=gPic.screen;
if(v==null)v=_obj("iHisSmooth").checked;
//_obj("iHisMergeTD").style.display=(v)?"":"none";
_obj("iHisDeltaTR").style.display=(v)?"":"none";
...
if(this.syncing)return;
var scr=gPic.screen;
if(v==null)v=_obj("iHisMerge").checked;
...
switch(mode){
 ...
 case 1: scr.history.loopmode="retrace"; break;
...
this.setValNew("iHistSpeed",speed); 
...
this.syncing=1;
try{
	_obj("iAniSpeedTxt").value=speed;
	this.setValNew("iAniSpeed",speed); 
...
this.syncing=1;
try{
	this.setValNew("iHisCurve",curve); 
...
//----- Save Replay -------
Toolbar.prototype.saveReplay=function(name,x){
if(!name)return;
gPic.hisName=name;
...
//----- Save Autoplay -----
Toolbar.prototype.saveAutoplay=function(name,x){
if(!name)return;
gPic.aniName=name;
asyncP("action=saverekord&dir="+parent.gDir+"&name="+name+"&text="+escape(x),"saverekord");
}
...
Toolbar.prototype.aniLoopMode=function(){   
if(this.syncing)return;
var scr=gPic.screen;
var mode=0;
var tmp=document.getElementsByName("iAniLoop");
for(var i=0;i<tmp.length;i++){
 if(tmp[i].checked){
  mode=i;
  break;
...
switch(mode){
 case 0: scr.animation.loopmode="oscillate"; break;
 case 1: scr.animation.loopmode="retrace"; break;
 case 2: scr.animation.loopmode="stop"; break;
}
}
...
this.syncing=1;
var scr=gPic.screen;
if(v==null)v=_obj("iAniDelta").value;
v=_round(v,2);
this.setValNew("iAniDelta",v);
_obj("iAniDeltaTxt").value=v;
this.syncing=0;
...
if(this.syncing)return;
var scr=gPic.screen;
var xmin=parseInt(_obj("iXAniRangeMin").value);
var xmax=parseInt(_obj("iXAniRangeMax").value);
var ymin=parseInt(_obj("iYAniRangeMin").value);
var ymax=parseInt(_obj("iYAniRangeMax").value);
//--- for some reason if these haven't changed we get a NaN ---
if(xmin==xmin){ scr.animation.xrangemin=xmin; }
if(xmax==xmax){ scr.animation.xrangemax=xmax; }
if(ymin==ymin){ scr.animation.yrangemin=ymin; }
if(ymax==ymax){ scr.animation.yrangemax=ymax; }
}
...
//------------------ add Video --------------------------------
Toolbar.prototype.addVideo=function(src){
if(!src){ try{ src=parent.frames[0].getRandomVideo();	}catch(e){}  }
try{ parent.frames[0].selectCurrent(src); }catch(e){}
if(!src)src="@vid@My2FRPA3Gf8";
gPic.addScreen("","video");
gToolbar.setPlayPauseBtn(gPic.playing);
gPic.screen.addImg(src,"",gPic.gDir,0);
}
...
this.syncing=0;
CP.open(window,gPic.desktop,'frameColor',_getLeftClick(event)-350,_getTopClick(event)-17,gPic.viewDesktopColor,0,gPic.desktopColor);
}
...
this.setValNew("iViewZoom",100);
}

Toolbar.prototype.viewResetSlide=function(){ 
this.syncing=1; 
this.setValNew("sldViewX",0);
this.setValNew("sldViewX",0);
this.syncing=0; 
this.setValNew("sldViewXY",0);
}

Toolbar.prototype.viewResetBlend=function(v){
gToolbar.setValNew('iViewBlend',0);
}

Toolbar.prototype.viewResetTilt=function(){
this.syncing=1;
gToolbar.setValNew('iViewTiltX',0);
gToolbar.setValNew('iViewTiltY',0);
this.syncing=0;
gToolbar.setValNew('iViewTilt',0);
}

Toolbar.prototype.viewResetSpin=function(){
gToolbar.setValNew('iViewSpin',0);
}
...
this.syncGradient("view");
this.setValNew("ssTimer",gPic.pauseDelay);
this.setValNew('iViewZoom',gPic.xViewZoom);
this.setValNew('iViewBlend',gPic.blend);
this.setValNew("sldViewXY",gPic.xViewSlide);
this.setValNew("sldViewX", gPic.xViewSlide);
this.setValNew("sldViewY", gPic.yViewSlide);
var str=gPic.perspective;
//msg("str="+str);
//msg("2drot="+gPic.getPerTilt(str));
this.setValNew('iViewSpin', gPic.getPerRotate(str));
this.setValNew('iViewTilt', gPic.getPerSkewX(str));
this.setValNew('iViewTiltX',gPic.getPerSkewX(str));
this.setValNew('iViewTiltY',gPic.getPerSkewY(str));
this.syncing=0;
}
...
this.setValNew("fldX",scr.xFold);
this.setValNew("fldY",scr.yFold);
this.setValNew("strX",scr.xStretch);
this.setValNew("strY",scr.yStretch);
this.setValNew("iScaleX",scr.xScale);
this.setValNew("zomXY",scr.xZoom); 
this.setValNew("zomX",scr.xZoom);
this.setValNew("zomY",scr.yZoom);
//this.setValNew("strXY",(100-((scr.xCrop+scr.yCrop)/2)));
//this.setValNew("strX",(100-scr.xCrop));
//this.setValNew("strY",(100-scr.yCrop));
//this.setValNew("strL",scr.lCrop);
//this.setValNew("strT",scr.tCrop);
this.setValNew("frkWH",((scr.xFrack+scr.yFrack)/2));
//this.setValNew("frkW",scr.xFrack);
//this.setValNew("frkH",scr.yFrack);
this.setValNew("sldXY",scr.xSlide);
this.setValNew("sldX",scr.xSlide);
this.setValNew("sldY",scr.ySlide);
this.setValNew("opcDV",scr.opacity1);
this.setValNew("iBlend",scr.blend);
...
this.setValNew("rszXY",scr.xSize);
this.setValNew("rszX",scr.xSize);
this.setValNew("rszY",scr.ySize);
this.setValNew("movXY",scr.xMove);
this.setValNew("movX",scr.xMove);
this.setValNew("movY",scr.yMove);
this.syncing=sync;
}
...
try{_obj("iSaveHisBtn").style.opacity=op;}catch(e){}
...
switch(scr.history.loopmode){
	case "oscillate": 	loopmode=0;	 break;
 	case "retrace"	: 	loopmode=1;	 break;
 	case "stop"		: 	loopmode=2;	 break;
}
_obj("iHisLoop"+loopmode).checked=true;
_obj("iHisSmooth").checked=(scr.history.smoothing)?true:false;
//_obj("iHisMergeTD").style.display=(scr.history.smoothing)?"":"none";
_obj("iHisDeltaTR").style.display=(scr.history.smoothing)?"":"none";
this.setValNew("iHistDelta",scr.history.delta); 
_obj("iHistDeltaTxt").value=scr.history.delta; 
this.setValNew("iHisCurve",scr.history.curve); 
//msg("timeout="+scr.history.timeout);
this.setValNew("iHistSpeed",scr.history.timeout); 
...
this.setValNew("iAniDelta",scr.animation.delta); 
this.setValNew("iAniSpeed",scr.animation.timeout); 
_obj("iAniSpeedTxt").value=scr.animation.timeout;
_obj("iAniDeltaTxt").value=scr.animation.delta; 
this.setValNew("iXAniRangeMin",scr.animation.xrangemin); 
this.setValNew("iXAniRangeMax",scr.animation.xrangemax); 
this.setValNew("iYAniRangeMin",scr.animation.yrangemin); 
this.setValNew("iYAniRangeMax",scr.animation.yrangemax); 
var loopmode=0;
switch(scr.animation.loopmode){
	case "oscillate": 	loopmode=0;	 break;
 	case "retrace"	: 	loopmode=1;	 break;
 	case "stop"		: 	loopmode=2;	 break;
}
_obj("iAniLoop"+loopmode).checked=true;
}
...
//this.setValNew("ixxy",xx);
//this.setValNew("ixxx",xx);
//this.setValNew("iyyy",yy);
this.setValNew("izxaxis",zx);
this.setValNew("izyaxis",zy);
this.setValNew("ixaxis",mx);
...
this.setValNew("perROT",rotate);
this.setValNew("perSWIVXY",perskx);	
this.setValNew("perSWIVX",perskx);
this.setValNew("perSWIVY",persky);
this.setValNew("perSP",persp);
//this.setValNew("perflipz",flipz);	//--- no control for this but keep it!
_obj("iOriginTxt").innerHTML=gPic.getOriginTxt(origin);
this.setValNew("perOriginOffset",originoffset);
...
perskx=gPic.getPerSkewX(str);
persky=gPic.getPerSkewY(str);
this.setValNew("perSKXY",perskx);  
this.setValNew("perSKX",perskx);
this.setValNew("perSKY",persky);
this.setValNew("perPanelSKXY",scr.xSkew);  
this.setValNew("perPanelSKX",scr.xSkew);
this.setValNew("perPanelSKY",scr.ySkew);
...
this.setValNew("perR3D",0);
this.setValNew("perRX",perrx);	
this.setValNew("perRY",perry);
this.syncing=tmpsyncing;
}
...
_obj("iD3ModeW").checked=false;
_obj("iD3ModeI").checked=false;
_obj("iD3ModeP").checked=false;
switch(v){
  case "window" : _obj("iD3ModeW").checked=true;  break;
  case "image"  : _obj("iD3ModeI").checked=true;  break;
  case "panels" : _obj("iD3ModeP").checked=true;  break;
}
}
...
}this.setValNew(view+"grdP",posi);
this.setValNew(view+"grdC1",obj.getGradPct1()*1);
this.setValNew(view+"grdC2",obj.getGradPct2()*1);
_obj(""+view+"grdT1").checked=false;
_obj(""+view+"grdT2").checked=false;
_obj(""+view+"grdT3").checked=false;
if(typ=="flat")  _obj(""+view+"grdT1").checked=true;
if(typ=="linear")_obj(""+view+"grdT2").checked=true;
if(typ=="radial")_obj(""+view+"grdT3").checked=true;
...
if(gPic.lockTiledImage){
	 if(y){
	  //this.setValNew("ixxx",	_obj("iyyy").value);
	  this.setValNew("izxaxis",_obj("izyaxis").value);
	  this.setValNew("ixaxis",	_obj("iyaxis").value);
	 }else{
	  //this.setValNew("iyyy",	_obj("ixxx").value);
	  this.setValNew("izyaxis",_obj("izxaxis").value);
	  this.setValNew("iyaxis",	_obj("ixaxis").value);
	 }
}
//this.setValNew("ixxy",	_obj("ixxx").value);
...
var scr=gPic.screen;
this.resetTileType(scr);
this.setValNew("ixxx",	_obj("ixxy").value);
this.setValNew("iyyy", _obj("ixxy").value);
...
var tmp=this.syncing;
this.syncing=1;
this.setValNew("perR3Dxy",0);
this.setValNew("perR3Dx",0);
this.setValNew("perR3Dy",0);
this.setValNew("perR3Dz",0);
this.setValNew("picR3Dxy",0);
this.setValNew("picR3Dx",0);
this.setValNew("picR3Dy",0);
this.syncing=tmp;
}
...
//var sync=this.syncing; this.syncing=1;this.setValNew("perRX",180);this.setValNew("perRY",180*d);this.syncing=sync;
this.setVars('3drot',v,0);
...
//var sync=this.syncing; this.syncing=1;this.setValNew("perRX",0);this.setValNew("perRY",180);this.syncing=sync;
this.setVars('3drot',v,0);
...
//var sync=this.syncing; this.syncing=1;this.setValNew("perRX",180);this.setValNew("perRY",0);this.syncing=sync;
this.setVars('3drot',v,0);
...
_obj("iSwapSample1").style.background=c1;
_obj("iSwapSample2").style.background=c2;
this.setValNew("iSwapColorsAlpha",alpha);
this.setValNew("iSwapColorsTolerance",tolerance);
this.syncSwapCs();
this.syncing=tmpsync;
}
...
this.setValNew("iFillColorAlpha",scr.FillColorAlpha);
this.setValNew("iFillColorTolerance",scr.FillColorTolerance);
...
this.setValNew("colorRgbRed",scr.colorRgbRed);
this.setValNew("colorRgbGreen",scr.colorRgbGreen);
this.setValNew("colorRgbBlue",scr.colorRgbBlue);
this.syncing=tmpsync;
}
...
_obj("mskT1").checked=false;
_obj("mskT2").checked=false;
_obj("mskT3").checked=false;
switch(typ){
	 case 2: _obj("mskT2").checked=true; break;
	 case 3: _obj("mskT3").checked=true; break;
	 case 1: default : _obj("mskT1").checked=true; break;
}
_obj("mskD0").checked=false;
_obj("mskD1").checked=false;
_obj("mskD2").checked=false;
_obj("mskD3").checked=false;
switch(mdir){
 case 0: _obj("mskD0").checked=true; break;
 case 1: _obj("mskD1").checked=true; break;
 case 2: _obj("mskD2").checked=true; break;
 case 3: _obj("mskD3").checked=true; break;
}
this.setValNew("mskStart",mstart);
this.setValNew("mskBlur",blur);
this.setValNew("mskRed",scr.maskRed);
this.setValNew("mskGreen",scr.maskGreen);
this.setValNew("mskBlue",scr.maskBlue);
this.setValNew("mskSolidAlpha",scr.maskSolidAlpha);
...
this.setValNew("iOilPaintRadius",scr.OilPaintRadius);
this.setValNew("iOilPaintIntensity",scr.OilPaintIntensity);
this.syncing=sync;
}
...
if(radius_changed){
	...
	this.setValNew("iPosterizeIntensity",scr.PosterizeIntensity);
}else{
...
this.setValNew("iPosterizeRadius",scr.PosterizeRadius);
this.setValNew("iPosterizeIntensity",scr.PosterizeIntensity);
this.syncing=sync;
}
...
this.setValNew("shdS",s);
this.setValNew("shdX",x);
this.setValNew("shdY",y);
this.setValNew("shdB",b);
this.setValNew("shdO",opacity);
this.setValNew("shdR",radius);
this.setValNew("clipRadius",clipradius);
_obj("shdI").checked=inset;
_obj("shdApplyTo1").checked=false;
_obj("shdApplyTo2").checked=false;
if(applyto==1)_obj("shdApplyTo1").checked=true;
else		  _obj("shdApplyTo2").checked=true;
}
...
this.setValNew(view+'fil_sat',this.getCSSFilter('saturate',filters));
this.setValNew(view+'fil_bri',this.getCSSFilter('brightness',filters));
this.setValNew(view+'fil_con',this.getCSSFilter('contrast',filters));
this.setValNew(view+'fil_hue',this.getCSSFilter('hue-rotate',filters));
this.setValNew(view+'fil_blu',this.getCSSFilter('blur',filters));
this.setValNew(view+'fil_sep',this.getCSSFilter('sepia',filters));
this.setValNew(view+'fil_gra',this.getCSSFilter('grayscale',filters));
this.setValNew(view+'fil_inv',this.getCSSFilter('invert',filters));
this.setValNew(view+'opcXY',obj.opacity2);
}
...
if(view==null)view="";
//syncing????
this.setValNew(view+'fil_sat',100);
this.setValNew(view+'fil_bri',100);
this.setValNew(view+'fil_con',100);
this.setValNew(view+'fil_hue',0);
this.setValNew(view+'fil_blu',0);
this.setValNew(view+'fil_sep',0);
this.setValNew(view+'fil_gra',0);
this.setValNew(view+'fil_inv',0);
this.setValNew(view+'opcXY',1);
}
...
if(v){
	...
	this.syncFullscreenBtns();
	this.syncSizes(); 
	if(gEmbedded)_obj("iFullScreen").src="_pvt_images/folders/toggle_collapse.png";
	var show=0;
}else{
	...
	if(gEmbedded)_obj("iFullScreen").src="_pvt_images/folders/toggle_expand.png";
	var show=1;
}
this.configHandles();
...
this.syncing=1;
this.setValNew("zomX",v); 
this.setValNew("zomY",v);
this.syncing=0;
this.setValNew("zomXY",v); 
}
...
if(k>36&&k<41){   
	...
	if(gEmbedded){
		if(ctrl){
			...
			switch(mode){
				...
				case "tilt"		: this.chgD3Mode(1);
								  ...
								  break; 
				case "turn" 	:
				default 		: scr.rotate(k-36);  return;
		...
		if(ctrl && shift)	this.setVars("panelskew",scr.xSkew+x,scr.ySkew+y,1);
		else if(ctrl)		this.setVars("split",scr.xSplit+x,scr.ySplit+y,1);
		else if(shift)		this.setVars("fold",scr.xFold+x,scr.yFold+y,1);	
	 	else 				{ scr.rotate(k-36); return; }
	}
	scr.repaint();			
	this.syncControls();
	return;
}
//	------- these interfere with browser shortcut keys, but ctrl/S doesn't work anyway ----
if(e && ctrl){
	//msg("k="+k+", e.code="+e.code);
	switch(e.code){
		case "KeyS" :	if (gEmbedded){ parent.savePixi();	e.preventDefault();	return false; }
		//case "KeyP"	: 	parent._obj("iPlayPause").click();	e.preventDefault();	return false; 
		//case "KeyF"	: 	parent._obj("iPlayFwd").click();	e.preventDefault();	return false; 
		//case "KeyB"	: 	parent._obj("iPlayBack").click();	e.preventDefault();	return false; 
	}
...
//---------------- save filter -----------------------
Toolbar.prototype.saveFilter=function(name,x){
if(!name)return;
asyncP("action=savefilter&dir="+parent.gDir+"&name="+name+"&text="+escape(x),"savefilter");
}
...
//------ setVal -------
Toolbar.prototype.setValNew=function(n,v){
switch(n){
...
try{_obj(n).value=v;}catch(e){msg("ERR setVal("+n);}
}
