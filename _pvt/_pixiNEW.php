...
<tr><td>
		...
		<TABLE id=iReplayTable cellspacing=0 cellpadding=0 style='width:100%;' >
			...
			<td colspan=3>
			   	<TABLE  cellspacing=0 cellpadding=0>
					<tr>
						...
						<td class="xAxis">Loop&nbsp;</td>	<td><input id=iRekLoop0 name=iRekLoop value=2 onchange="gToolbar.historyLoopMode()" type=radio checked>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td class="xAxis">Once&nbsp;</td>	<td><input id=iRekLoop1 name=iRekLoop value=4 onchange="gToolbar.historyLoopMode()" type=radio>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td class="xAxis">Stop&nbsp;</td>	<td><input id=iRekLoop2 name=iRekLoop value=1 onchange="gToolbar.historyLoopMode()" type=radio></td>
					</tr>
		   		</TABLE>
			</td>
			</tr>
   			...
   			<tr><td width=50 class="xAxis">Curve</td><td><input id=iRekCurve type="range"  min="25" max="75" value="50" step="1" oninput="gToolbar.historyPlayCurve(this.value)" /></td><td></td></tr>
			...
			<tr id=iRekDeltaTR><td class="xAxis">Delta</td><td><input id=iHistDelta type="range"  min="1" max="50" value="25" step="1" oninput="gToolbar.histPlayDelta(this.value)" /></td><td width=20><input id=iHistDeltaTxt type="text" value="0" onchange="gToolbar.histPlayDelta(this.value)" style='width:28px;font-size:12px;' /></td></tr>
   			<tr><td colspan=3><div style='height:0px;'></div></td></tr>
			<tr style="DISPLAY:;"><td colspan=3>
   				<TABLE  cellspacing=0 cellpadding=0><tr>
					<td width=53>Relative</td>
   					<td width=22><input id=iRekRelative onchange="gToolbar.setRekRelative()" type=checkbox style='position:relative;top:2px;'></td>
   					<td></td>
				</tr></TABLE>
			</td></tr>
			<tr style="DISPLAY:;"><td id=iRekMergeTD colspan=3>
   				<TABLE  cellspacing=0 cellpadding=0><tr>
		...
		<TABLE  id=iAutoPlayTable cellspacing=0 cellpadding=0 style='width:100%;position:relative;top:0px;' >
			...
			<tr><td>
  			<TABLE cellspacing=0 cellpadding=0 style='DISPLAY:;'>
  				<tr><td class="xAxis" width=40>X-Min</td><td><input id=iXRekRangeMin type="range" min="0" max="100" value="40" step="1" oninput="gToolbar.historyRange('Min')" /></td><td><input id=iAniX type=checkbox checked  onchange="gToolbar.aniXchg(this.checked)" style='position:relative;top:9px;left:2px;'></td></tr>
  				<tr><td class="xAxis">X-Max</td><td><input id=iXRekRangeMax  type="range" min="0" max="100" value="60" step="1" oninput="gToolbar.historyRange('Max')" /></td><td></td></td></tr>
   				<tr><td colspan=3><div style='height:4px;'></div></td></tr>
  				<tr><td class="xAxis">Y-Min</td><td><input id=iYRekRangeMin  type="range" min="0" max="100" value="40" step="1" oninput="gToolbar.historyRange('Min')" /></td><td><input id=iAniY type=checkbox checked onchange="gToolbar.aniYchg(this.checked)" style='position:relative;top:9px;left:2px;'></td></tr>
  				<tr><td class="xAxis">Y-Max</td><td><input id=iYRekRangeMax  type="range" min="0" max="100" value="60" step="1" oninput="gToolbar.historyRange('Max')" /></td><td></td></td></tr>
				<tr><td  class="xAxis">Pause</td><td><input id=iRekSpeed type="range"  min="0" max="500" value="0" step="1" oninput="gToolbar.historyPlaySpeed(this.value)" /></td><td width=20><input id=iRekSpeedTxt type="text" value="0" onchange="gToolbar.historyPlaySpeed(this.value)" style='width:28px;font-size:12px;' /></td></tr>
				<tr><td class="xAxis">Delta</td><td><input id=iRekDelta type="range"  min="0.02" max="20" value="0.2" step="0.02" oninput="gToolbar.historyPlayDelta(this.value)" /></td><td width=20><input id=iRekDeltaTxt type="text" value="0" onchange="gToolbar.historyPlayDelta(this.value)" style='width:28px;font-size:12px;' /></td></tr>
  			</TABLE>
 			</td></tr>
			<? if($gLoggedIn){ ?>
...
try{
	...
	this.setValNew("iRekSpeed",speed); 
...
this.syncing=1;
try{
	this.setValNew("iRekCurve",curve); 
...
this.setValNew("iRekCurve",scr.history.curve); 
...
this.setValNew("iRekDelta",scr.animation.delta); 
this.setValNew("iRekSpeed",scr.animation.timeout); 
_obj("iRekSpeedTxt").value=scr.animation.timeout;
_obj("iRekDeltaTxt").value=scr.animation.delta; 
this.setValNew("iXRekRangeMin",scr.animation.xrangemin); 
this.setValNew("iXRekRangeMax",scr.animation.xrangemax); 
this.setValNew("iYRekRangeMin",scr.animation.yrangemin); 
this.setValNew("iYRekRangeMax",scr.animation.yrangemax); 
}
