...
for(var y=0;y<this.yyy;y++){
    ...
    blend = sessionStorage.getItem("blend")
    this.setBlend(blend ? blend : 0);
...
cssFilters = sessionStorage.getItem("cssFilters")
if (cssFilters) {
	this.cssfilters = cssFilters // (backend)
}
...
if(noapply!=1)setOpacity(this.div,sessionStorage.getItem('opacity2')*99);
