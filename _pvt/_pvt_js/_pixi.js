...
"Filters"	are saved layout settings without the image (and some minor settings like position and size)
...
if(gPic.playing){
	x+=" gPic.playScreen=gPic.screens["+gPic.playScreen.scrix+"]; ";
	x+=" gPic.playPause(); ";	//slideshow
}
x+=anis;
