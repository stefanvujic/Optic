...
<script src="_pvt_js/_pixiNEW.js"></script>
...
<DIV style='position:absolute;top:48px;right:0px;'>
	...
	<img id=iShowHandles class='corners2' onclick='gToolbar.showHandles()' style='position:absolute;top:7px;right:137px;height:14px;width:16px; border:solid 2px <?=$scrollbgcolor;?>;border-top:solid 5px <?=$scrollbgcolor;?>; cursor:pointer;' src='_pvt_images/delete.png' title='show handles'>
...
<TABLE id='iDebugTools' cellspacing=0 cellpadding=0 style='width:100%;position:relative;top:6px;left:10px;'>
 ...
 <td><input class=dbgbtn type=button value=" doneStuff  "   onclick="doneStuff()"></td>
...
msg("=================");
msg("unDoing="+gPic.unDoing);
msg("doneIX="+gPic.doneIX);
msg("doneStuff="+gPic.doneStuff);
msg("=================");
}
