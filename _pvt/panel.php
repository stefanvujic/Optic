...
<!-- /optic-cdf26213a150dc3ecb610f18f6b38b46/_pvt/_toolbar.php -->
<HTML lang="en">
<HEAD>
<link href='http://fonts.googleapis.com/css?family=Economica|Economica' rel='stylesheet' type='text/css'>
<script src='_pvt_js/util.js'></script>

<!-- <title>jdb.ywv.mybluehost.me</title> -->
<title>Optic</title>
<STYLE type="text/css">
html       {background:#ffffff;  }
body       {background:transparent;color:#555555;font-family:Economica;font-size:24px;margin:0; cursor: default;}
.txthdr    {font-size:22px;letter-spacing:1px;color:#ff0000;}
.listhdr   {font-size:24px;text-transform:uppercase;letter-spacing:2px;color:#ff0000;}
.hdrlnk    {color:#555555;cursor:pointer;}
.hdrlnk:hover{color:#0000ff;}
.lnk       {font-size:24px;color:dodgerblue;cursor:pointer;padding-left:2px;padding-right:2px;}
.lnk:hover {color:#0000ff;}
a          {color:dodgerblue;}
a:hover    {color:#0000ff;}
.modebtn   {color:#000000;background:#ffffff;overflow:hidden;padding-left:2px;width:51px;height:21px;}
.sqbtn     {height:22px;border:solid 1px #666666;color:#000000;background:#ffffff;overflow:hidden;text-align:center;padding-left:2px;padding-right:3px;text-decoration:none;cursor:pointer;}
.sqbtnoff  {height:22px;border:solid 1px #999;color:#999;background:#ccc;    overflow:hidden;text-align:center;padding-left:2px;padding-right:3px;text-decoration:none;}
.btn       {height:22px;border:solid 1px #666666;color:#000000;background:#ffffff;overflow:hidden;text-align:center;padding-left:2px;padding-right:3px;text-decoration:none;-moz-border-radius: 6px; -webkit-border-radius: 6px; -moz-border-radius: 6px; -webkit-border-radius: 6px;;cursor:pointer;}
.btnoff    {height:22px;border:solid 1px #999;color:#999;background:#ccc;    overflow:hidden;text-align:center;padding-left:2px;padding-right:3px;text-decoration:none;-moz-border-radius: 6px; -webkit-border-radius: 6px; -moz-border-radius: 6px; -webkit-border-radius: 6px;;}
.mnubtn    {-moz-border-radius: 0px; -webkit-border-radius: 0px; -moz-border-radius: 0px; -webkit-border-radius: 0px;;height:16px;text-align:left;border:solid 0px white;}
.c_gobtn   {height:22px;width:12px;overflow:hidden;}
.c_closebtn{height:26px;width:16px;position:absolute;top:0;left:100;overflow:hidden;}
.c_thumbdivs {float:left; width:100px; height:70px; padding:4px; background-color:#ffffff; }
...
var gRoot 		="http://jdb.ywv.mybluehost.me/";
...
var gLoginPath  ="";
var gLoginDirLink=""; 
var gLoginDir   ="";      //this gets changed to be become the 'active' dir within the login path
var gAcctAdmin  =(0)?1:0;
var gAdmin      =(0)?1:0;
var gAutoLogin  =0;
...
var gShowlinks=1;
var gShowupload=0;
var gShownewfolder=0;
var gShownewfile=0;
var gShownewlink=0;
var gShownewfimg=0;
var gShownewsvg=0;
var gShownewvid=0;
var gShoworgfolders=0;
var gShowupdsettings=0;
var gShowpopupmenu=0;
...
//---- template variables -----
var gMouseoverMenus="yes";
var gHomePage="Default.ixi";
...
//--------------------------------mouseovers -----------------------------------
function _hilite(o){o.style.background='#dddddd';}
function _lolite(o){o.style.background='#ffffff';}
function _lnkHilite(o){o.style.color='#0000ff';}
function _lnkLolite(o){o.style.color='';}
function _menuHilite(o){o.style.color='#ffffff';}
function _menuLolite(o){o.style.color='#dddddd';}
function _hiliteImg(o){o.style.border='solid 1px #dddddd';}
...
gShowToolbar=1;  //defined in _inc_header
...
var gLastUrl="http://jdb.ywv.mybluehost.me";
...
var gMenuWidth=140,gMenuPct;

var gWidth,gHeight,gBoxWidth,gScreenWidth;

var gPopupBgColor="moccasin";
...
var gShowCameraBtn ='yes';

var gShowLoginBtn  ='yes';
...
var pic=getMenuObj().getNextPic(i,mask,currentsrc);
...
try{ _obj("iLogoutBtn").style.display=(hasRights && gID && gShowLoginBtn)?"":"none";   				}catch(e){}

try{ _obj("iLogout2Btn").style.display=(!hasRights && gID && gShowLoginBtn)?"":"none"; 				}catch(e){}

try{ _obj("iLoginBtn").style.display=(!gID && gShowLoginBtn)?"":"none";								}catch(e){}

try{ if(gID)_obj("iLogoutBtn").title=_obj("iLogout2Btn").title="Logout ["+gID+"]";					}catch(e){}
...
var movers="onmouseover='_hilite(this)' onmouseout='_lolite(this)'";
...
.c_vfloat    {position:absolute;top:3px;left:3px;width:140px;height:96%;padding:1px;-moz-border-radius: 6px; -webkit-border-radius: 6px; -moz-border-radius: 6px; -webkit-border-radius: 6px;;z-index:9;}
...
.c_popuptable{font-family:economica;font-size:18pt;padding:3px;color:black;background:#ffffff;color:#000000;border:solid 1px #666666;";
...
<DIV id='iWindow0' class='corners8 slideBg' style='resize:none; display:none; border:solid 1px black;padding:10px; background:moccasin; color:#555555; position:absolute; z-index:999; left:145px; top:28px; width:40%; height:90%;'><TABLE border=0 cellpadding=0 cellspacing=0 style='resize:none;width:100%;height:100%;' ><tr id=iWindowToolbar0 style='height:34px;border-bottom:solid 0px black;color:white;overflow:hidden;cursor:move;'><td id=iWindowTitle0 align=left style='color:#555555;cursor:move;font-size:22pt;letter-spacing:2px;padding-left:15px;position:relative;top:-2px;' ></td><td align=right valign=top><TABLE border=0 id=iWinBtns0 class='slideOpacity' cellpadding=0 cellspacing=0><tr><td width=34><IMG id=iWinHide0 onclick='hideWindow(0)' src='_pvt_images/folders/toggle_minimize.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG id=iWinToggle0 onclick='expandWindow(0)' src='_pvt_images/folders/toggle_expand.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG onclick='closeWindow(0)' src='_pvt_images/close.png' style='width:26px;cursor:pointer;position:relative;top:0px;left:0px;'></td></tr></TABLE></td></tr><tr><td colspan=2 id=iWindowBox0 style='resize:none;border:solid 1px #aaaaaa; background:white;'></td></tr></TABLE></DIV><DIV id='iWindow1' class='corners8 slideBg' style='resize:none; display:none; border:solid 1px black;padding:10px; background:moccasin; color:#555555; position:absolute; z-index:9991;left:145px; top:28px; width:40%; height:90%;'><TABLE border=0 cellpadding=0 cellspacing=0 style='resize:none;width:100%;height:100%;' ><tr id=iWindowToolbar1 style='height:34px;border-bottom:solid 0px black;color:white;overflow:hidden;cursor:move;'><td id=iWindowTitle1 align=left style='color:#555555;cursor:move;font-size:22pt;letter-spacing:2px;padding-left:15px;position:relative;top:-2px;' ></td><td align=right valign=top><TABLE border=0 id=iWinBtns1 class='slideOpacity' cellpadding=0 cellspacing=0><tr><td width=34><IMG id=iWinHide1 onclick='hideWindow(1)' src='_pvt_images/folders/toggle_minimize.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG id=iWinToggle1 onclick='expandWindow(1)' src='_pvt_images/folders/toggle_expand.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG onclick='closeWindow(1)' src='_pvt_images/close.png' style='width:26px;cursor:pointer;position:relative;top:0px;left:0px;'></td></tr></TABLE></td></tr><tr><td colspan=2 id=iWindowBox1 style='resize:none;border:solid 1px #aaaaaa; background:white;'></td></tr></TABLE></DIV><DIV id='iWindow2' class='corners8 slideBg' style='resize:none; display:none; border:solid 1px black;padding:10px; background:moccasin; color:#555555; position:absolute; z-index:9992;right:20px; top:51%;  width:35%; height:45%;'><TABLE border=0 cellpadding=0 cellspacing=0 style='resize:none;width:100%;height:100%;' ><tr id=iWindowToolbar2 style='height:34px;border-bottom:solid 0px black;color:white;overflow:hidden;cursor:move;'><td id=iWindowTitle2 align=left style='color:#555555;cursor:move;font-size:22pt;letter-spacing:2px;padding-left:15px;position:relative;top:-2px;' ></td><td align=right valign=top><TABLE border=0 id=iWinBtns2 class='slideOpacity' cellpadding=0 cellspacing=0><tr><td width=34><IMG id=iWinHide2 onclick='hideWindow(2)' src='_pvt_images/folders/toggle_minimize.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG id=iWinToggle2 onclick='expandWindow(2)' src='_pvt_images/folders/toggle_expand.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG onclick='closeWindow(2)' src='_pvt_images/close.png' style='width:26px;cursor:pointer;position:relative;top:0px;left:0px;'></td></tr></TABLE></td></tr><tr><td colspan=2 id=iWindowBox2 style='resize:none;border:solid 1px #aaaaaa; background:white;'></td></tr></TABLE></DIV><DIV id='iWindow3' class='corners8 slideBg' style='resize:none; display:none; border:solid 1px black;padding:10px; background:moccasin; color:#555555; position:absolute; z-index:9993;right:20px; top:28px; width:35%; height:45%;'><TABLE border=0 cellpadding=0 cellspacing=0 style='resize:none;width:100%;height:100%;' ><tr id=iWindowToolbar3 style='height:34px;border-bottom:solid 0px black;color:white;overflow:hidden;cursor:move;'><td id=iWindowTitle3 align=left style='color:#555555;cursor:move;font-size:22pt;letter-spacing:2px;padding-left:15px;position:relative;top:-2px;' ></td><td align=right valign=top><TABLE border=0 id=iWinBtns3 class='slideOpacity' cellpadding=0 cellspacing=0><tr><td width=34><IMG id=iWinHide3 onclick='hideWindow(3)' src='_pvt_images/folders/toggle_minimize.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG id=iWinToggle3 onclick='expandWindow(3)' src='_pvt_images/folders/toggle_expand.png' style='display:none;width:28px;cursor:pointer;position:relative;top:0px;left:0px;'></td><td width=34><IMG onclick='closeWindow(3)' src='_pvt_images/close.png' style='width:26px;cursor:pointer;position:relative;top:0px;left:0px;'></td></tr></TABLE></td></tr><tr><td colspan=2 id=iWindowBox3 style='resize:none;border:solid 1px #aaaaaa; background:white;'></td></tr></TABLE></DIV>
...
<TABLE id=iMainTable border=0 cellpadding=0 cellspacing=0 width=100% height=100% style='position:absolute;top:0px;left:0px;width:100%;height:100%;overflow:hidden;'>
 ...
 <tr id=iToolbar style='' >

 

 <td align=left colspan=2 style='border-bottom:solid 1px #ccc; height:28px;overflow:hidden;'>

	 <TABLE border=0 cellpadding=0 cellspacing=0 style='width:100%;'><tr><td style='width:190px;height:28px;border-right:solid 0px #ccc;'><TABLE id=iAdminButtons border=0 cellpadding=0 cellspacing=0 style='display:block;overflow:hidden;'><tr><td><div id=iToolbarSpacer style='width:41px;'></div></td><td><IMG id=iLogoutBtn   src='_pvt_images/login.png'   onclick='logout()' style='display:none;position:relative;top:1px;cursor:pointer;width:20px;height:20px;padding-left:1px;' onmouseover='moLoginBtns(this,1)' onmouseout='moLoginBtns(this,0)' title='logout'><IMG id=iLogout2Btn  src='_pvt_images/logout2.png' onclick='logout()' style='display:none;position:relative;top:1px;cursor:pointer;width:20px;height:20px;padding-left:1px;' onmouseover='moLoginBtns(this,1)' onmouseout='moLoginBtns(this,0)' title='logout'><IMG id=iLoginBtn    src='_pvt_images/logout.png'  onclick='login()'  style=';position:relative;top:1px;cursor:pointer;width:20px;height:20px;padding-left:1px;' onmouseover='moLoginBtns(this,1)' onmouseout='moLoginBtns(this,0)' title='login'></td><td style='width:13px;'></td><td id=iPopupMenuBtn style='display:none;' ><IMG class=c_barbtn src='_pvt_images/add_new.png' onclick='gAddMenu.clickMenuBtn(this)' style='position:relative;top:1px;left:0px;height:16px;width:16px;opacity:0.8;' title='add NEW'></td><td style='width:12px;'></td><td id=iSettingsBtn style='display:none;' ><IMG class=c_barbtn src='_pvt_images/settings.png' onclick='loadx("options")' style='position:relative;top:1px;left:0px;height:16px;width:16px;opacity:0.8;' title='settings'></td><td style='width:13px;'></td><td><IMG class=c_barbtn src='_pvt_images/home.png' onclick='loadHome()' title='go home' style='position:relative;top:2px;width:18px;height:18px;'></td></tr></TABLE></td><td style='width:70px;'></td><td align=center>
	 ...
	 <img id=iPlayPause src='_pvt_images/forward.png'  id=iPlayPauseBtn onclick='gPixi.gPic.playPause()' style='position:relative;top:1px;width:25px;cursor:pointer;background:#ffffff;opacity:0.7;' title='play/pause'>
	 ...
	 <img id=iPlayFwd    src='_pvt_images/play.png'  onclick='gPixi.gPic.screen.nextImage(1,null,1);gPixi.gToolbar.viewImage();' style='position:relative;top:-2px;width:18px;cursor:pointer;background:#ffffff;opacity:0.7; '>
		...
		<td style='padding-left:0px;'></td></td><td align=left style='height:28px;width:273px;border-left:solid 1px #ccc;'>
        <TABLE cellspacing=0 cellpadding=0 style='width:100%;overflow:hidden;'><tr><td id='iAddChildMenu' style='height:28px;width:22px;padding-left:4px;'><img class='c_barbtn' src='_pvt_images/addgreen.png' onclick='gAddChildMenu.clickMenuBtn(this)' style='position:relative;top:0px;height:20px;width:20px;padding:1px;' title='new layer'></td><td align=right style=''>
        <TABLE cellspacing=0 cellpadding=0><tr><td><img class='c_barbtn' onclick="gPixi.gPic.lastDesktopColor=gPixi.gPic.desktopColor;gPixi.CP.open(window,gPixi.gPic.desktop,'frameColor',_getLeftClick(event)-195,_getTopClick(event)-15,gPixi.gPic.viewDesktopColor,0,gPixi.gPic.desktopColor);"' src='_pvt_images/color.gif' style='width:24px;height:26px;' title='view background color'></td><td style='padding-left:6px;'></td><td><img id=iUndoBtn class='c_barbtn corners4' onclick='gPixi.gPic.unDone(-1)' style='position:relative;top:-2px;left:2px;width:20px;height:20px;opacity:0.3;' src='_pvt_images/undo.png' title='undo'></td><td>
            <img id='iDoneReset' class='c_barbtn' src='_pvt_images/reset.png' onclick='gPixi.gToolbar.resetDoneStuff()' style='position:relative;top:5px;width:16px;height:16px;cursor:pointer;opacity:0.3;' title='reset history'></td><td><img id=iRedoBtn class='c_barbtn corners4' onclick='gPixi.gPic.unDone(1)' style='position:relative;top:-2px;left:-2px;width:20px;height:20px;opacity:0.3;' src='_pvt_images/redo.png' title='redo'></td><td><img id=iSaveConfigBtn class='c_btnbig' src='_pvt_images/save1.png' onclick='savePixi()'  style='padding-left:5px;width:33px;height:33px;cursor:pointer;' title='save view'></td><td width=6></td><td><IMG id=iCameraBtn style='width:24px;height:25px;position:relative;top:2px;left:0px;' class=c_barbtn src='_pvt_images/camera.png' onclick='takePic()' title='capture view image'></td><td width=8></td><td><IMG style='position:relative;top:2px;' class=c_barbtn src='_pvt_images/help.png' onclick='window.open("help.php")' title='tips'></td><td width=14></td><td width=31 ><img id=iMenuControlsBtn class='c_barbtn corners4' src='_pvt_images/arrow_red.png' onclick='gPixi.gToolbar.openMenuControls()' style='width:20px;height:20px;position:relative;top:2px;' title='tools'></td><td width=10></td></tr></TABLE></td></tr></tr>
        </TABLE>
        </td></tr></tr></TABLE></td></tr><tr><td id=td0 class='XslideWidth' style='width:140px;overflow-x:hidden;border-right:solid 1px #ccc;border-left:solid 1px #ccc;' valign=top>
        <IFRAME id=imenu name=imenu src='_menu.php?autoload=yes' frameborder='0' border='0' style='width:100%;height:100%;overflow-x:hidden;'></IFRAME>
        </td><td align=right><TABLE id=iDesktopTable cellpadding=0 cellspacing=0 width=100% height=100%><tr><td id=td2>
            <IFRAME id=iscreen name=iscreen src='' frameborder='0' border='0' style='width:100%;height:100%;overflow:hidden;'></IFRAME>
        </td></tr></TABLE></td></tr></TABLE>
<IMG id=iFlipMenu onmouseover="arrowFade(1)" onmouseout="arrowFade(0)" src="_pvt_images/arrow_red.png" onclick="flipMenu(null,0)" ondblclick="flipMenu(null,1)" style="width:20px;height:20px;display:block;position:absolute;top:5px;left:8px;cursor:default;z-index:9999;cursor:pointer;">

<IMG id=iMenuDivider src="_pvt_images/leftright.png" style="display:block;width:22px;position:absolute;top:36px;left:110;cursor:pointer;z-index:1; " title="drag to resize">
